...
const Certifications = () => {
    ...
    useGSAP(() => {
        ...
        const showIndex = (next) => {
            ...
            slides[activeIndex] && gsap.to(slides[activeIndex],
                { autoAlpha: 0, duration: 0.2, overwrite: true })

            slides[next] && gsap.to(slides[next],
        ...
        <section className="section pin-section" id="certification" ref={sectionRef}>
            <div className="certification-header">
                ...
                <p className='certification-description'>
                    ...
                    but certifications and honors are the proof of dedication,
                    hard work, and expertise in a particular field. They not only validate
                    my skills but also demonstrate my commitment to continuous learning and
                    professional growth. Each certification and honor represents a milestone in my
                    journey, showcasing my ability to excel and contribute meaningfully to the industry.
                </p>
            </div>
